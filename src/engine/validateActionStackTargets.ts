...
export function validateActionStackTargets(asi: ActionStackItem, targetMap: Map<string, Nameable>): boolean {
  const instigatorPasses = asi.instigator === null || !!targetMap.get(asi.instigator);
